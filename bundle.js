...
var pomodoroElement = document.querySelector('.container');
var timerDisplay = document.querySelector('.timer');
var timerProgress = document.querySelector('progress');

var workDurationInput = document.querySelector('#work-duration');
var breakDurationInput = document.querySelector('#break-duration');
var intervalNameElem = document.querySelector('.interval-name');
var startButton = document.querySelector('#start-button');
var stopButton = document.querySelector('#stop-button');
var chimeSound = document.querySelector('audio');
...
var getBreakDuration = function getBreakDuration() {
...
var displayIntervalName = function displayIntervalName(name) {
...
var ACCEPTED_EVENTS = ['tick', 'interval-start', 'interval-end'];
...
ACCEPTED_EVENTS.forEach(function (eventType) {
  eventHandlers[eventType] = [];
});

exports.default = {
  start: function start(workDurtionMinutes, breakDurationMinutes) {
    durations = [];
  ...
  getPreviousIntervalName: function getPreviousIntervalName() {
    var index = (currentDurationIndex > 0 ? currentDurationIndex : durations.length) - 1;
    return durations[index].name;
  },
  getCurrentIntervalName: function getCurrentIntervalName() {
    return durations[currentDurationIndex].name;
  },
  getDuration: function getDuration() {
    return durations[currentDurationIndex].length;
  },
  getTimeRemaing: function getTimeRemaing() {
